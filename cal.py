...
btn_clear = tk.Button(root, text="clear", command=clear_field, width=25, font=("Arial", 14))
...
btn_sum = tk.Button(root, text="=", command=evaluate_calculation, width=25, font=("Arial", 14))
btn_sum.grid(row=5, column=2, columnspan=4)
